...
ActiveRecord::Schema.define(version: 20140617145851) do
  ...
  add_index "users_categories", ["user_id", "category_id"], name: "index_users_categories_on_user_id_and_category_id", using: :btree
