class Post < ActiveRecord::Base
  ...
  attr_accessible :title, :description, :urgency, :budget, :owner, :parking, :quote, :how_did_you_here_about_us, :parking, :publish_date, :category_ids, :photo, :assigned_to_id, :state
